<?php
/**
 * Notification Bell Component for Student and Staff Pages
...
$bellRole = $_SESSION['role'] ?? 'student';
if ($bellRole === 'staff') {
    $notifViewAllLink = (strpos($notifApiPath, '../') === 0) ? '' : 'staff/';
    $notifViewAllLink .= 'notifications.php';
} else {
    $notifViewAllLink = (strpos($notifApiPath, '../') === 0) ? '' : 'student/';
    $notifViewAllLink .= 'notifications.php';
}
?>
<div class="notif-bell-wrapper">
    ...
    <div class="notif-dropdown" id="notifDropdown">
        ...
        <div class="notif-footer">
            <a href="<?php echo $notifViewAllLink; ?>" class="notif-view-all">

...
<div class="app-bg">
    <div class="main-card">
        ...
        <?php $currentPage = 'resources'; include __DIR__ . '/../includes/adminMaster.php'; ?>
...
<script>
    ...
    function renderAdminBookings(bookings) {
        ...
        tbody.innerHTML = bookings.map((b, idx) => {
            ...
            const createdAt = b.created_at ? (() => { const _d = new Date(b.created_at); return `${String(_d.getDate()).padStart(2,'0')}-${String(_d.getMonth()+1).padStart(2,'0')}-${_d.getFullYear()} ${String(_d.getHours()).padStart(2,'0')}:${String(_d.getMinutes()).padStart(2,'0')}`; })() : '-';
            const bookingDate = b.bookingDate.split('-').reverse().join('-');

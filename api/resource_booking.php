    ...
    switch ($action) {
        ...
        case 'create':
            ...
            if ($insertStmt->execute()) {
                ...
                // Create notification for bookings
                if ($userRole === 'student' || $userRole === 'staff') {
                    ...
                    $notifRole = $userRole;
                    $notifStmt = $db->prepare("INSERT INTO notifications (userID, userRole, type, title, message, link) VALUES (?, ?, 'booking_update', ?, ?, ?)");
                    $notifStmt->bind_param("sssss", $userID, $notifRole, $notifTitle, $notifMsg, $notifLink);
                    $notifStmt->execute();
                }

...
<body>
                ...
                <nav class="sidebar-nav">
                    <ul>
                        ...
                        <li class="nav-group is-open" data-expandable>
                            <button class="nav-item nav-toggle" type="button" aria-expanded="true" data-target="student-menu">
                                <span class="nav-icon"><i class="fa-solid fa-users"></i></span>
                                <span class="nav-label">Student</span>
                                <span class="nav-chevron"></span>
                            </button>
                            <div id="student-menu" class="nav-submenu">
                                <a href="tutorial-management.php" class="nav-subitem" style="background: rgba(255,255,255,0.1);">Tutorial Management</a>
            ...
            <main class="dashboard">
                ...
                <div class="page-header">
                    ...
                    <div class="page-header-text">
                        ...
                        <p>Manage students in your tutorial and practical classes</p>
                    </div>
                </div>
    ...
    <script>
        ...
        async function loadStudents() {
            ...
            try {
                const response = await fetch(`../api/tutorialManagement.php?action=getStudents&programID=${encodeURIComponent(currentProgram)}&tutGroup=${encodeURIComponent(currentTutGroup)}&status=${currentTab}`);
        ...
        async function viewStudent(studentId) {
            ...
            try {
                const response = await fetch(`../api/tutorialManagement.php?action=getStudentProfile&studentID=${encodeURIComponent(studentId)}`);
                const data = await response.json();
        ...
        btnGenerateReport.addEventListener('click', () => {
            if (!currentProgram || !currentTutGroup) return;
            window.open(`../api/tutorialManagement.php?action=generateReport&programID=${encodeURIComponent(currentProgram)}&tutGroup=${encodeURIComponent(currentTutGroup)}`, '_blank');
        });

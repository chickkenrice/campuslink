            ...
            <main class="dashboard">
                <header class="dashboard-topbar">
                    ...
                    <div class="topbar-right">
                        <div class="user-card">
                            <span class="user-name" style="color: var(--text-main);"><?php echo htmlspecialchars($staffName); ?></span>
                            <span class="user-status" style="color: var(--text-sub);">Staff ID: <?php echo htmlspecialchars($staffID); ?></span>
                        </div>
                    </div>
                </header>

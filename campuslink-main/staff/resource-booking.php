                        ...
                        <div class="rb-booking-form">
                            ...
                            <div id="purpose-section" style="display:none;">
                                <div class="rb-form-group" style="margin-top: 15px;">
                                    ...
                                    <input type="text" id="rb-purpose" placeholder="e.g. Faculty meeting, Lab session, Badminton..." maxlength="255">
                                </div>
...
<script>
    ...
    async function submitBooking() {
        ...
        if (!purpose) { showBookingMsg('Please enter a purpose for your booking.', 'error'); return; }
        const startTime = slotData[selectedSlots.start].start;
        const endIndex = selectedSlots.endClicked !== null && selectedSlots.endClicked !== undefined 
            ? selectedSlots.endClicked 
            : selectedSlots.end + 1;

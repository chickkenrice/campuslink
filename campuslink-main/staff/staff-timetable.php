        ...
        <aside class="sidebar" aria-label="Primary navigation">
            ...
            <nav class="sidebar-nav">
                <ul>
                    ...
                    <li><a href="staff-attendance.php" class="nav-item"><span class="nav-icon"><i class="fa-solid fa-clock"></i></span> Attendance</a></li>
                    <li><a href="staff-timetable.php" class="nav-item is-active"><span class="nav-icon"><i class="fa-solid fa-calendar-days"></i></span> My Timetable</a></li>
            ...
            <header class="dashboard-topbar">
                ...
                <div class="topbar-right">
                    <div class="user-card" style="display: flex; align-items: center; gap: 12px; flex-direction: row-reverse;">
                        <div class="profile-pic" style="width: 42px; height: 42px; border-radius: 50%; background: var(--purple-tint); display: grid; place-items: center; border: 2px solid var(--purple-soft);">
                            <i class="fa-solid fa-chalkboard-teacher" style="color: var(--purple-base); font-size: 18px;"></i>
                        </div>
                        <div class="user-meta" style="text-align: right;">
                            <span class="user-name" style="display: block; font-weight: 600; color: var(--text-main);"><?php echo htmlspecialchars($staffName); ?></span>
                            <span class="user-status" style="font-size: 12px; color: var(--text-sub);"><?php echo htmlspecialchars($staffType); ?></span>
                        </div>
                    </div>
                </div>
            </header>

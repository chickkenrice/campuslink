...
function renderGrid($list) {
    ...
    <?php else: 
        foreach($list as $row): 
            ...
            $deadlineFormatted = date('M j, Y \a\t g:i A', $deadlineTs);
            ...
            if(!$row['subStatus']) {
                ...
                if($diffSecs < 0) {
                    ...
                    $deadlineText = 'Due ' . date('M j', $deadlineTs);
                }
            } else {
                ...
                if($row['subStatus'] == 'Graded') {
                    ...
                    $deadlineText = 'Graded on ' . date('M j', strtotime($row['submittedAt']));
                    ...
                    $deadlineText = 'Submitted ' . date('M j', strtotime($row['submittedAt']));
                    $deadlineColor = '#059669';
                }
            }
        ?>

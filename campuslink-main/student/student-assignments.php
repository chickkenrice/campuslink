                ...
                <div class="page-header" style="margin-bottom: 20px;">
                    <div style="display: flex; align-items: center; gap: 12px;">
                        <div style="width: 40px; height: 40px; background: linear-gradient(135deg, #8056ff 0%, #6366f1 100%); border-radius: 12px; display: flex; align-items: center; justify-content: center;">
                            <i class="fa-solid fa-file-pen" style="color: white; font-size: 18px;"></i>
                        </div>
                        <div>
                            <h1 style="font-size: 1.5rem; font-weight: 700; color: var(--text-main); margin: 0;">Assignments</h1>
                            <p style="color: var(--text-light); margin: 2px 0 0 0; font-size: 13px;">Track deadlines and submit your work</p>
                        </div>
                    </div>
                </div>

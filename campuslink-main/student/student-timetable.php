        ...
        <aside class="sidebar" aria-label="Primary navigation">
            ...
            <nav class="sidebar-nav">
                <ul>
                    ...
                    <li>
                        <a href="student-timetable.php" class="nav-item is-active">
                ...
                <div class="topbar-right">
                    <div class="user-card" style="display: flex; align-items: center; gap: 12px; flex-direction: row-reverse;">
                        ...
                        <div class="user-meta" style="text-align: right;">
                            <span class="user-name" style="display: block; font-weight: 600; color: var(--text-main);"><?php echo htmlspecialchars($studentName); ?></span>

    ...
    <div class="term-modal">
        ...
        <div class="term-form-grid">
            ...
            <div class="form-group">
                ...
                <input type="number" id="formWeeks" value="14" min="1" max="20">
            </div>
            <div class="form-group">
                <label>Status *</label>
...
function openCreateModal() {
    ...
    document.getElementById('formWeeks').value = '14';
...
async function saveTerm() {
    ...
    // Basic validation
    if (!data.programID || !data.academicYear || !data.year || !data.semester || !data.startDate || !data.endDate) {

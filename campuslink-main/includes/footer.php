<?php
/**
 * CAMPUSLink Footer Component
 * Include this inside the <main> element, before closing </main>
 */
?>
<!-- Footer -->
<footer class="cl-footer">
    ...
    <div class="cl-footer-content">
        ...
        <span class="cl-footer-divider">|</span>
        <span class="cl-footer-copyright">COPYRIGHT © <?php echo date('Y'); ?> <strong>CAMPUSLink. ALL RIGHTS RESERVED</strong></span>

            ...
            <aside class="sidebar" aria-label="Primary navigation">
                ...
                <nav class="sidebar-nav">
                    <ul>
                        ...
                        <li>
                            <a href="student/student-attendance.php" class="nav-item">
                        ...
                        <li>
                            <a href="student/student-assignments.php" class="nav-item">
                        ...
                        <li>
                            <a href="student/student-timetable.php" class="nav-item">
                        ...
                        <li>
                            <a href="student/resource-booking.php" class="nav-item">
                        ...
                        <li class="nav-group" data-expandable>
                            ...
                            <div class="nav-submenu" id="programme-panel" hidden>
                                <a href="student/programme-structure.php" class="nav-subitem">Programme Structure</a>
                                <a href="student/course-enrollment.php" class="nav-subitem">Course Enrollment</a>

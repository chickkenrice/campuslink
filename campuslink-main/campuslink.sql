...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 14, 2026 at 05:21 PM
...
(478, '23WP94665', 28, '2026-02-13', '21:32:14', 'Present'),
...
('23WP12509', 'U013', 'Arvind A/L Subramaniam', 'arvind.12509@student.tarc.edu.my', '012-2262226', 'Group A', 'RSD', 1, 1, NULL),
...
--
ALTER TABLE `activity_logs`
  MODIFY `logID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=470;
...
--
ALTER TABLE `attendance`
  MODIFY `recordID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=480;
...
--
ALTER TABLE `class_group_removals`
  MODIFY `removalID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

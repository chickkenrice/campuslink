...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 13, 2026 at 04:18 PM
...
('23WP12509', 'U013', 'Arvind A/L Subramaniam', 'arvind.12509@student.tarc.edu.my', '012-2262226', 'Group A', 'RSD', 1, 1, 'profile_23WP12509_1770906440.jpg'),
...
--
ALTER TABLE `activity_logs`
  MODIFY `logID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=416;
...
--
ALTER TABLE `class_group_removals`
  MODIFY `removalID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

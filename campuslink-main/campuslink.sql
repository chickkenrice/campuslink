...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 11, 2026 at 04:39 PM
...
(2, '2025/2026', 2, 'RSD', 1, '2026-03-30', '2026-07-11', NULL, NULL, 14, 'Active', '2026-01-29 12:27:52'),
...
CREATE TABLE `course_prerequisite` (
  `courseID` varchar(12) NOT NULL,
  `prerequisiteID` varchar(12) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
('23WP12509', 'U013', 'Arvind A/L Subramaniam', 'arvind.12509@student.tarc.edu.my', '012-2262226', 'Group A', 'RSD', 1, 1),
...
('23WP99001', 'U057', 'Alex Chen Wei Jie', 'alex.99001@student.tarc.edu.my', '012-3334455', 'Group A', 'RSD', 1, 1),
('25WP00001', 'U059', 'Test Student Y2S2', 'test.y2s2@student.tarc.edu.my', '012-3456789', 'Group A', 'RSD', 2, 2);
...
ALTER TABLE `student_course_history`
  ...
  ADD UNIQUE KEY `studentID` (`studentID`,`courseID`,`academicYear`,`semester`),
  ADD KEY `courseID` (`courseID`);
...
--
ALTER TABLE `activity_logs`
  MODIFY `logID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=301;
...
--
ALTER TABLE `attendance`
  MODIFY `recordID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=478;

--
-- AUTO_INCREMENT for table `attendance_sessions`
--
ALTER TABLE `attendance_sessions`
  MODIFY `sessionID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=72;
...
--
ALTER TABLE `course_prerequisite`
  ADD CONSTRAINT `course_prerequisite_ibfk_1` FOREIGN KEY (`courseID`) REFERENCES `course` (`courseID`) ON DELETE CASCADE,
  ADD CONSTRAINT `course_prerequisite_ibfk_2` FOREIGN KEY (`prerequisiteID`) REFERENCES `course` (`courseID`) ON DELETE CASCADE;
...
--
ALTER TABLE `student_course_history`
  ADD CONSTRAINT `student_course_history_ibfk_1` FOREIGN KEY (`studentID`) REFERENCES `student` (`studentID`) ON DELETE CASCADE,
  ADD CONSTRAINT `student_course_history_ibfk_2` FOREIGN KEY (`courseID`) REFERENCES `course` (`courseID`) ON DELETE CASCADE;

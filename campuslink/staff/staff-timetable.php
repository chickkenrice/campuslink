            ...
            <header class="dashboard-topbar">
                ...
                <div class="topbar-right">
                    <div class="user-card" style="display: flex; align-items: center; gap: 12px; flex-direction: row-reverse;">
                        <div class="profile-pic" style="width: 42px; height: 42px; border-radius: 50%; background: #e0e7ff; display: grid; place-items: center; border: 2px solid #c7d2fe;">
                            <i class="fa-solid fa-chalkboard-teacher" style="color: #4f46e5; font-size: 18px;"></i>
                        </div>
                        <div class="user-meta" style="text-align: right;">
                            <span class="user-name" style="display: block; font-weight: 600; color: #333;"><?php echo htmlspecialchars($staffName); ?></span>
                            <span class="user-status" style="font-size: 12px; color: #666;"><?php echo htmlspecialchars($staffType); ?></span>
                        </div>
                    </div>
                </div>
            </header>

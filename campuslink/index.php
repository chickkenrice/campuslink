            ...
            <aside class="sidebar" aria-label="Primary navigation">
                ...
                <nav class="sidebar-nav">
                    <ul>
                        ...
                        <li>
                            <a href="student/student-attendance.php" class="nav-item" style="text-decoration: none;">
                        ...
                        <li>
                            <a href="student/student-timetable.php" class="nav-item" style="text-decoration: none;">
                ...
                <header class="dashboard-topbar">
                    ...
                    <div class="topbar-right">
                        <div class="user-card" style="display: flex; align-items: center; gap: 12px; flex-direction: row-reverse;">
                            <a href="student/student-profile.php" class="profile-link" title="View Profile" style="text-decoration: none; cursor: pointer;">

...
<div class="app-bg">
    <div class="main-card">
        ...
        <?php $currentPage = 'resource-booking'; include __DIR__ . '/../includes/studentMaster.php'; ?>
...
<script>
    ...
    function renderScheduleTimeline(facilities, date, container) {
        ...
        const _dlD = new Date(date + 'T00:00:00');
        const dayLabel = ['Sun','Mon','Tue','Wed','Thu','Fri','Sat'][_dlD.getDay()] + ', ' + date.split('-').reverse().join('-');
